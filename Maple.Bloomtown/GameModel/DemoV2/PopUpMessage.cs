...
namespace Maple.Bloomtown.GameModel.Demo
{
    ...
    { 
        ...
        public readonly unsafe partial struct Ptr_PopUpMessage(nint ptr)
        {
            ...
            {
                return ref System.Runtime.CompilerServices.Unsafe.AsRef<Ref_PopUpMessage>(_ptr.ToPointer());
            }
        }
        ...
        { 
            ...
            /// <returns>struct System.Void</returns>
            /// public  extern void SHOW_MESSAGE (nint text);
