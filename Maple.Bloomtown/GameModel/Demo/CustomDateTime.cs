...
namespace Maple.Bloomtown.GameModel.Demo
{
    ...
    /// 
    /// </summary>
    //[Maple.MonoGameAssistant.MonoCollectorDataV2.MonoCollectorSettingsAttribute([65, 115, 115, 101, 109, 98, 108, 121, 45, 67, 83, 104, 97, 114, 112], 0x02000808U)]
    ...
    public partial class CustomDateTime
    {
        ...
        //public const uint Const_TypeToken = 0x02000808U;
        ...
        public readonly unsafe partial struct Ptr_CustomDateTime(nint ptr)
        {
            ...
            {
                return ref Unsafe.AsRef<Ref_CustomDateTime>(_ptr.ToPointer());
            }
        }
